...
class Board:
    ...
    def slide_squares(self, row):
        ...
        for x in row:
            if x:
                if (inew > 0 and x == new[inew-1] and
                    icmb != inew-1):
...
class Game:
    ...
    def __init__(self, gw):
        ...
        self.lbl_cb = Label(self.top_fr, 
                            ...
                            fg = self.darkgreen,
                            bg = self.lightgreen)
        self.lbl_cb.place(relx = 0.08, rely =  0.35, anchor = W)
        ...
        self.goal_cb = ttk.Combobox(self.top_fr,
                                    ...
                                    width = 7,
                                    height = 30)
        self.goal_cb.place(relx = 0.08, rely = 0.6, anchor = W)
        ...
        for r in range(4):
            for c in range(4):
                ...
                game_sq = Label(self.bd_fr,
                                ...
                                bg = bg_color,
                                font = 'times 16 bold')
                game_sq.place(x = objx, y = objy, height = objh, width = objw)
